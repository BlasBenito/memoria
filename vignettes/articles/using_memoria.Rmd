...
# Fit a simple tree
tree_model <- rpart(
  formula = Response_0 ~ Response_Lag_0.2 + climate.temperatureAverage_Lag_0.2,
  data = lagged_data,
...
rf_data <- lagged_data[, grepl("Response|climate", colnames(lagged_data))]
...
plotInteraction(
  model = rf_model,
  data = rf_data,
  x = "climate.temperatureAverage_Lag_0",
  y = "Response_Lag_0.2",
  z = "Response_0",
