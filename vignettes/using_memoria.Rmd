...
<!-- --- -->
<!-- title: Quantifying ecological memory in palaeoecological datasets and other long time-series with the \emph{memoria} package. -->
<!-- author: "Blas M. Benito" -->
<!-- output: -->
<!--   pdf_document: -->
<!--     fig_caption: yes -->
...
The aim is to fit a model of the form shown in **Equation 1** on the data shown in **Table 1**: 
