...
#' @param endogenous.component character string, name of the variable defining the endogenous component. If the data was generated by \code{\link{prepareLaggedData}}, \code{endogenous.component} would usually be \code{"Response"}.
#' @param sampling.subset only relevant when \code{memory.pattern} is the result of \code{runExperiment}. Character string with the name of the column of the list with the simulation outcomes.
...
#'   \item \emph{strength.concurrent} numeric in the range [0, 100], same as above, but for the concurrent component (driver at lag 0).
...
#'   \item \emph{length.exogenous} numeric in the range [0, 100], same as above but for the exogenous memory component.
