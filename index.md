...
for several taxa and several climate variables.
...
![](reference/figures/README-unnamed-chunk-5-1.png) Notice that in the
plot above, time, in thousands of years before present, goes from right
(oldest) to left (newest).
...
trains Random Forest models with the lagged data, using “pinus_0” as
response, all other variables as predictors, and a randomly generated
